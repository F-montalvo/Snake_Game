...
// functions utilize JS Arrow and Spread Syntax

//function that returns a array of key to get the range
const getRange = length => [...Array(length).keys()]

//function that returns the array without the last element
const getWithoutLastElement = array => array.slice(0, array.length - 1)

//fumction that checks if two numbers are equal
